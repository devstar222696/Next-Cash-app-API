...
const sliderSettings = {
  ...
  cssEase: "linear",
  appendDots: (dots: any) => (
    <div className='p-0 m-0 text-black dark:text-white'>
      ...
      {UserRoles.includes(userInfo.role) && (
        <div>
          ...
          <Image
            ...
            height={70}
            alt="chatting"
            className="absolute right-5 bottom-[5px] sm:bottom-[10px] z-50 cursor-pointer hover:scale-105 sm:right-14"
            onClick={chatting}
          />
        </div>
      )}
